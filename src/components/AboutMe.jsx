    ...
    <div className="flex flex-col md:flex-row items-center justify-between px-8 md:px-16 py-16 md:py-20 text-black m-5 md:m-0 lg:m-0 ">
      ...
      <div className="md:w-1/2">
        ...
        <button
          ...
          className="btn-primary border text-black px-5 py-3 font-normal text-base cursor-pointer text-center transition duration-500 hover:bg-purple-500 hover:text-white hover:border-none mr-4"
        >
          Learn More
        </button>
      </div>
